...
* [] Auto fix of genome in redactor -- Currently in work
* [] Writing new shaders
* [] Adding logic for phagocyte and adding dead cells (Cells which are not functional and can be eated with phagocyte)
